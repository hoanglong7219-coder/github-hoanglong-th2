  ...
  <div className='flex items-center justify-center bg-[#00000087] h-[100vh]'>
    <div className='w-[800px] h-[444px] flex'>
      <div className='w-[500px] h-[529px] pt-[40px] px-[45px] pb-[24px] bg-[#fff] rounded-lg gap-5' >
        ...
        <InputForm className='outline-none text-[14px] shadow appearance-none border rounded w-[410px] h-[37px] py-[10px] border-b-4  text-[#242424] leading-tight focus:outline-none focus:shadow-outline' id="password" type="text" placeholder="PassWord" />
        </div>
